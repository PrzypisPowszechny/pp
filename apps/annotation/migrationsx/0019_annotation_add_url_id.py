...
def populate_url_id(apps, schema):
    migrate_one_class(apps.get_model('annotation.Annotation'))
    migrate_one_class(apps.get_model('annotation.AnnotationRequest'))
    migrate_one_class(apps.get_model('annotation.HistoricalAnnotation'))


class Migration(migrations.Migration):
    dependencies = [
        ('annotation', '0018_rename_ranges_to_range'),
    ]
